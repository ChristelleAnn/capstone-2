    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-blue-50 to-blue-100 flex items-center justify-center p-8">
            <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-lg">
                ...
                <div className="bg-blue-600 shadow-md rounded p-6 text-white mb-6">
                ...
                <div className="bg-blue-700 shadow-md rounded p-6 mb-6">
                ...
                <div className="bg-blue-800 shadow-md rounded p-6 text-white">
